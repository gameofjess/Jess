...
public class ArgumentParserTest {
     ...
     */
    @Test
    void regularTest() throws InvalidOptionException, InvalidHostnameException, InvalidPortException{
        ...
        assertArrayEquals(ArgumentParser.getOpts(args), new Option[]{Option.dedicatedServer, hostname, port});
    }
     ...
     */
    @Test
    void regularServerTest() throws InvalidOptionException, InvalidHostnameException, InvalidPortException {
        String[] args = {"-s"};
     ...
     */
    @Test
    void regularPortTest() throws InvalidOptionException, InvalidHostnameException, InvalidPortException {
     ...
     */
    @Test
    void regularHostTest() throws InvalidOptionException, InvalidHostnameException, InvalidPortException {
        // -- IP Test --
    ...
    void InvalidOptionExceptionTest() {
        ...
        for(char c = 65; c <= 90; c++){
            if(!(shortAliases.contains(c))){
                char finalC = c;
                assertThrows(InvalidOptionException.class, () -> ArgumentParser.getOpts(new String[]{"-" + finalC}));
            }
        }
    ...
    void InvalidPortExceptionTest() {
        ...
        for(int i = 0; i < 1000; i++){
            int finalI = i;
            assertThrows(InvalidPortException.class, () -> ArgumentParser.getOpts(new String[]{"-p", String.valueOf(finalI)}));
        }
        ...
        assertThrows(InvalidPortException.class, () -> ArgumentParser.getOpts(new String[]{"-p", "somethingdifferent"}));
    }
    ...
    void invalidHostnameExceptionTest(){
        ...
        for(String ip : invalidIPs){
            assertThrows(InvalidHostnameException.class, () -> ArgumentParser.getOpts(new String[]{"-H", ip}));
        }

        String[] invalidHostnames = {"-test.example.org", "test with space.example.org", "test/with/slashes.example.org", "test.with.dot."};
        for(String host : invalidHostnames){
            assertThrows(InvalidHostnameException.class, () -> ArgumentParser.getOpts(new String[]{"-H", host}));
        }
    }
