...
public enum Option {
     ...
     * @return Option object that is represented by given short alias or null if such an object does not exist.
     */
     ...
     * @return Option object that is represented by given long alias or null if such an object does not exist.
     */
